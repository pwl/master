...
\begin{proof}
  ...
  $\lvert A\rvert$.%  The above bound is not optimal, but is sufficient
  % for our purposes. As the map $\psi_A$ leaves the north and south
  % poles of $S^k$ unchanged, the map $F_A$ is of the homotopy class
  % that $F$ and we conclude by the following theorem.
